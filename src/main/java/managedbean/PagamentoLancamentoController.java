...
@Named(value="pagamentoLancController")
@ViewScoped
public class PagamentoLancamentoController implements Serializable{
	...
	public PagamentoLancamentoController(){
...
//	        
	...
	public void carregarLancamentosNãoProvisionados(){
		...
		lancamentos = service.getLancamentosNãoProvisionados(filtro);	
		//service.getPagamentosPE(filtro);
	}
	
	public void carregarPagamentosPE(){
		pagamentosPE = new ArrayList<>();
		pagamentosPE = service.getPagamentosPE(filtro);
	}
