...
public class DonationRepo implements Serializable {
	...
	public List<LancamentoAuxiliar> loadDisbursementInProject(Filtro filtro) {
		...
		StringBuilder hql = new StringBuilder(getSQLDefaultToDisbursement());
		
		if (filtro.getTipo().equals("donation")) {
			hql.append("and o.id = :id_donation ");			
		} else if (filtro.getTipo().equals("project")) {
			hql.append("and p.id = :id_project ");			
		}
	...
	public List<LancamentoAuxiliar> loadAdvancesInProjects(Filtro filtro) {
		...
		hql.append("and p.id = :id_project ");
		hql.append("and l.tipo_v4 = 'SA' ");
		hql.append("and l.statusAdiantamento = 'EM_ABERTO' ");
	...
	public String getSQLDefaultToDisbursement() {
