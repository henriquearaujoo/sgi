...
public class CadAprocacaoRepositorio {

	@Inject
	private EntityManager manager;

	public CadAprocacaoRepositorio() {
	}

	public CadAprocacaoRepositorio(EntityManager manager) {
		this.manager = manager;
	}
	
	public List<Acao> getForAprove(Projeto projeto) {
		// jpql
