...
public class ProjetoService implements Serializable{
	...
	public void remover(Projeto projeto){
		try {
			...
			addMessage("", "Não foi possível remover projeto, entre me contato com  o Administrador do sistema.", FacesMessage.SEVERITY_ERROR);
		}
	...
	public Integer getQuantidadeAtividadeMes(Projeto projeto, StatusAtividade status, int mes, Boolean planejado, int ano) {
		try{
			...
			//return repositorio.getQuantidadeAtividadeMes(projeto,status,mes,planejado,ano);
		}catch(NoResultException e){
			return 0;
		}
	}
