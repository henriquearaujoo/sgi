...
@Entity
@Table(name = "destino_esgoto_familiar")
public class DestinoEsgotoFamiliar implements Serializable{
	...
	private TipoDestinoEsgotoFamiliar tipo;
	...
	public TipoDestinoEsgotoFamiliar getTipo() {
		return tipo;
	}

	public void setTipo(TipoDestinoEsgotoFamiliar tipo) {
		this.tipo = tipo;
	}
