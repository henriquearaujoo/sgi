...
@Entity
@Table(name = "atividade_renda_comunitario")
public class AtividadeRendaComunitario implements Serializable{
	...
	@ManyToOne
	private AtividadeRenda atividade;
	...
	public AtividadeRenda getAtividade() {
		return atividade;
	}

	public void setAtividade(AtividadeRenda atividade) {
