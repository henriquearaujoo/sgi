...
@Entity
@Table(name = "destino_lixo_familiar")
public class DestinoLixoFamiliar implements Serializable{
	...
	private TipoDestinoLixoFamiliar tipo;
	...
	public TipoDestinoLixoFamiliar getTipo() {
		return tipo;
	}

	public void setTipo(TipoDestinoLixoFamiliar tipo) {
		this.tipo = tipo;
	}
