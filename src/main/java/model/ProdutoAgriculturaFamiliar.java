...
@Entity
@Table(name = "produto_agricultura_familiar")
public class ProdutoAgriculturaFamiliar implements Serializable{
	...
	@ManyToOne
	private ProdutoAgricultura produto;
	...
	public ProdutoAgricultura getProduto() {
		return produto;
	}

	public void setProduto(ProdutoAgricultura produto) {
