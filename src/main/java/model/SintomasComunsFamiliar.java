...
@Entity
@Table(name = "sintomas_comuns_familiar")
public class SintomasComunsFamiliar implements Serializable{
	...
	public SintomaComum getSintoma() {
		return sintoma;
	}

	public void setSintoma(SintomaComum sintoma) {
