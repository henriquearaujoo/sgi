...
@Entity
@Table(name = "financiamento_transporte_comunitario")
public class FinanciamentoTransporteComunitario implements Serializable{
	...
	private TipoFinanciadorComunitario tipo;
	...
	public TipoFinanciadorComunitario getTipo() {
		return tipo;
	}

	public void setTipo(TipoFinanciadorComunitario tipo) {
		this.tipo = tipo;
	}
