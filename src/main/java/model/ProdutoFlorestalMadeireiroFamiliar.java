...
@Entity
@Table(name = "produto_florestal_madeireiro_familiar")
public class ProdutoFlorestalMadeireiroFamiliar implements Serializable{
	...
	@ManyToOne
	private ProdutoFlorestalMadeireiro produto;
	...
	public ProdutoFlorestalMadeireiro getProduto() {
		return produto;
	}

	public void setProduto(ProdutoFlorestalMadeireiro produto) {
