...
@Entity
@Table(name = "forma_energia_comunitario")
public class FormaEnergiaComunitario implements Serializable{
	...
	@ManyToOne
	private FonteEnergia formaEnergia;
	...
	public FonteEnergia getFormaEnergia() {
		return formaEnergia;
	}

	public void setFormaEnergia(FonteEnergia formaEnergia) {
		this.formaEnergia = formaEnergia;
	}
