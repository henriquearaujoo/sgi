...
@Entity
@Table(name = "forma_pegar_agua_comunitario")
public class FormaPegarAguaComunitario implements Serializable{
	...
	private TipoFormasPegarAguaComunitario tipo;
	...
	public TipoFormasPegarAguaComunitario getTipo() {
		return tipo;
	}

	public void setTipo(TipoFormasPegarAguaComunitario tipo) {
		this.tipo = tipo;
	}
