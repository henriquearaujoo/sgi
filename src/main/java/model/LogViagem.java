...
@Entity
@Table(name = "log_viagem")
public class LogViagem implements Serializable{
	...
	private Long id;
	@ManyToOne
	private SolicitacaoViagem viagem;
	@ManyToOne
