...
@Entity
@Table(name = "material_informativo_comunitario")
public class MaterialInformativoComunitario implements Serializable{
	...
	@ManyToOne
	private MaterialInformativo material;
	...
	public MaterialInformativo getMaterial() {
		return material;
	}

	public void setMaterial(MaterialInformativo material) {
